...
class TemporalRecognitionNode(Node):
    ...
    def __init__(self) -> None:
        ...
        self.declare_parameter('expected_count', 6)
        self.declare_parameter('window_frames', 30)
        self.declare_parameter('grid_resolution_m', 0.005)
        self.declare_parameter('minimum_occupancy', 0.15)
        self.declare_parameter('maximum_component_span_m', 0.12)
