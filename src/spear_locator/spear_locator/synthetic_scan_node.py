"""Publish a synthetic LaserScan containing equally spaced spear targets."""
...
class SyntheticScanNode(Node):
    """Generate a repeatable scan for development without LiDAR hardware."""
    ...
    def __init__(self) -> None:
        ...
        self.declare_parameter('target_x_m', 1.2)
        self.declare_parameter('target_pitch_m', 0.20)
        ...
        self.get_logger().info('Publishing synthetic equally spaced targets on /scan')
